...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "which", "whose","whom","can you","whats's","where's","how's"]
...
class ChatSection(QWidget):
    def __init__(self, parent=None):
        super(ChatSection, self).__init__(parent)
        ...
        movie = QMovie(GraphicsDirectoryPath('J 0.0.gif'))
        max_gif_size_w = 480
        max_gif_size_H = 270
        ...
        self.setStyleSheet("""
            ...
            QScrollBar : add-page:vertical , QScrollBar:: sub-pagee:vertical {
                backgrgound:none;
            }
        """)
...
class MessageScreen(QWidget):
    ...
    def __init__(self, parent=None):
        super(MessageScreen, self).__init__(parent)
        desktop = QApplication.desktop()
        screen_width = desktop.screenGeometry().width()
        screen_height = desktop.screenGeometry().height()
        layout = QVBoxLayout()
