...
# AV voice link for types https://gist.github.com/BettyJJ/17cbaa1de96235a7f5773b8690a20462
...
def TTS(Text, func=lambda r=None: True):
    while True:
        try:
            ...
            try:
                # Call the provided function with False to signal the end of the loop
                func(False)
